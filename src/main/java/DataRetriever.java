...
public class DataRetriever {
    ...
    Dish saveDish(Dish toSave) {
        ...
        try (Connection conn = new DBConnection().getConnection()) {
            ...
            // Replace dish_ingredient links: delete existing then insert provided
            deleteDishIngredients(conn, dishId);
            insertDishIngredients(conn, dishId, toSave.getIngredients());
    ...
    private void insertDishIngredients(Connection conn, Integer dishId, List<Ingredient> ingredients) throws SQLException {
        ...
        try (PreparedStatement ps = conn.prepareStatement(insertSql)) {
            for (Ingredient ingredient : ingredients) {
                int id = getNextSerialValue(conn, "dish_ingredient", "id");
                ps.setInt(1, id);
                ps.setInt(2, dishId);
    ...
    private List<Ingredient> findIngredientByDishId(Integer idDish) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                ingredient.setPrice(priceObj == null ? null : resultSet.getDouble("price"));
                ...
                ingredient.setUnit(unitStr == null ? null : UnitTypeEnum.fromDatabase(unitStr));
